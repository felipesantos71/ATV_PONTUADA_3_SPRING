...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NomeDoPratoJaCadastradoException.class)
    public ResponseEntity<Map<String, Object>> handlerNomeDoPratoJaCadastradoException(NomeDoPratoJaCadastradoException erro) {
        return ResponseEntity
